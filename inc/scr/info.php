...
<?php
    ...
    $sql_command = "SELECT project_title, project_image1, project_image2, project_image3, project_tinyinfo, project_longinfo, project_language, project_team, project_complete, project_date FROM projects WHERE project_id = ?";
